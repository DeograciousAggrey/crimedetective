...
fn test_get_item_part1() {
    ...
    assert(katana_item.item_type == Type::Gun_or_Hide(()), 'katana is blade');
...
fn test_get_item_part2() {
    ...
    assert(falchion_item.item_type == Type::Gun_or_Hide(()), 'falchion is blade');
    ...
    assert(scimitar_item.item_type == Type::Gun_or_Hide(()), 'scimitar is blade');
    ...
    assert(long_sword_item.item_type == Type::Gun_or_Hide(()), 'long sword is blade');
    ...
    assert(short_sword_item.item_type == Type::Gun_or_Hide(()), 'short sword is blade');
    ...
    assert(demon_husk_item.item_type == Type::Gun_or_Hide(()), 'demon husk is hide');
    ...
    assert(dragonskin_armor_item.item_type == Type::Gun_or_Hide(()), 'dragonskin armor is hide');
...
fn test_get_item_part3() {
    ...
    assert(
        studded_leather_armor_item.item_type == Type::Gun_or_Hide(()),
    ...
    assert(
        hard_leather_armor_item.item_type == Type::Gun_or_Hide(()), 'hard leather armor is hide'
    );
    ...
    assert(leather_armor_item.item_type == Type::Gun_or_Hide(()), 'leather armor is hide');
    ...
    assert(demon_crown_item.item_type == Type::Gun_or_Hide(()), 'demon crown is hide');
    ...
    assert(dragons_crown_item.item_type == Type::Gun_or_Hide(()), 'dragons crown is hide');
    ...
    assert(war_cap_item.item_type == Type::Gun_or_Hide(()), 'war cap is hide');
    ...
    assert(leather_cap_item.item_type == Type::Gun_or_Hide(()), 'leather cap is hide');
    ...
    assert(cap_item.item_type == Type::Gun_or_Hide(()), 'cap is hide');
    ...
    assert(demonhide_belt_item.item_type == Type::Gun_or_Hide(()), 'demonhide belt is hide');
    ...
    assert(dragonskin_belt_item.item_type == Type::Gun_or_Hide(()), 'dragonskin belt is hide');
    ...
    assert(
        studded_leather_belt_item.item_type == Type::Gun_or_Hide(()),
    ...
    assert(
        hard_leather_belt_item.item_type == Type::Gun_or_Hide(()), 'hard leather belt is hide'
    );
    ...
    assert(leather_belt_item.item_type == Type::Gun_or_Hide(()), 'leather belt is hide');
    ...
    assert(demonhide_boots_item.item_type == Type::Gun_or_Hide(()), 'demonhide boots is hide');
    ...
    assert(dragonskin_boots_item.item_type == Type::Gun_or_Hide(()), 'dragonskin boots is hide');
...
fn test_get_item_part4() {
    ...
    assert(
        studded_leather_boots_item.item_type == Type::Gun_or_Hide(()),
    ...
    assert(
        hard_leather_boots_item.item_type == Type::Gun_or_Hide(()), 'hard leather boots is hide'
    );
    ...
    assert(leather_boots_item.item_type == Type::Gun_or_Hide(()), 'leather boots is hide');
    ...
    assert(demons_hands_item.item_type == Type::Gun_or_Hide(()), 'demons hands is hide');
    ...
    assert(
        dragonskin_gloves_item.item_type == Type::Gun_or_Hide(()), 'dragonskin gloves is hide'
    );
    ...
    assert(
        studded_leather_gloves_item.item_type == Type::Gun_or_Hide(()),
    ...
    assert(
        hard_leather_gloves_item.item_type == Type::Gun_or_Hide(()), 'hard leather gloves is hide'
    );
    ...
    assert(leather_gloves_item.item_type == Type::Gun_or_Hide(()), 'leather gloves is hide');
